...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        labelBR.snp.makeConstraints { maker in
            ...
            maker.bottom.equalTo(viewButtons).inset(20)
        }
...
//            make.height.equalToSuperview()
        ...
        let buttonClear = UIButton(frame: CGRect(x: viewButtons.frame.width - 0, y: viewButtons.frame.height - 0, width: buttonSize, height: buttonSize))
